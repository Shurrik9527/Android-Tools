...
public class SelectVideoPresenter implements SelectVideoContract.Presenter{
    ...
    private static final String TAG =SelectVideoPresenter.class.getName();
    private Context mContext;
    private SelectVideoContract.View mView=null;

    public SelectVideoPresenter(final SelectVideoContract.View view, Context context) {
        this.mView = view;
