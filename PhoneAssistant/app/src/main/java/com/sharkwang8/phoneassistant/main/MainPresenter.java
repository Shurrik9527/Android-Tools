...
public class MainPresenter implements MainContract.Presenter {
    ...
    public void uploadDeviceInform(DeviceInformBean deviceInformBean) {
        ...
        HttpCenter.getService().uploadDeviceInform(deviceInformBean.getADNROID_ID(),deviceInformBean.getPHONE_NUMBER(),deviceInformBean.getOPERATOR(),deviceInformBean.getNETWORK_TYPE(),deviceInformBean.getCOUNTRY_CODE(),deviceInformBean.getOPERATOR_CODE(),
